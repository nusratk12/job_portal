...
(10, 'Habibur', 'Fahim', '87654321', '35736763', 'hrfahim735@gmail.com', '2021-09-19', '4YEARS EXPERIENCE', 'GRADUATED', 'DHAKA', 'DHANMONDI', 'Digital Design', '5000-20000', NULL, NULL);
...
--
ALTER TABLE `job_provider`
  MODIFY `JOB_PROVIDER_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `job_seeker`
--
ALTER TABLE `job_seeker`
  MODIFY `JOB_SEEKER_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
