                  ...
                  <form class="form" action="update.php" method="post" id="registrationForm">
                      ...
                      <div class="form-group">
                           <div class="col-xs-12">
                                ...
                                <a href="http://localhost/online%20Job-portal_main/Homepage/homepage.php" class="btn btn-lg btn-success" type="submit" name="save"><i class="glyphicon glyphicon-ok-sign"></i> Done</a>
                            </div>
                      </div>
                      <?php } ?>
              	</form>
