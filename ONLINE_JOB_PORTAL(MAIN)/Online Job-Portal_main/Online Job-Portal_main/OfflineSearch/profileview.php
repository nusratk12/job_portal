                ...
                <hr>
                  <form class="form" action="update.php" method="post" id="registrationForm">
                      ...
                      <div class="form-group">
                           <div class="col-xs-12">
                                <br>
                              	<a href="http://localhost/online%20Job-portal_main/Confirmation/confirmation.php" class="btn btn-primary btn-lg" role="button" type="reset"><i class="glyphicon glyphicon-repeat"></i> NEXT </a>
                            </div>
                      </div>
                      <?php } ?>
              	</form>
